...
var questions = [
  {
    ...
    status: 0,
    questionSet: [
      "CON LA A. Conjunto de islas agrupadas en una superficie más o menos extensa de mar.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA B. Sitio poblado de árboles y matas.",
      "CON LA B. Eliminar.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA C. Dicho de una persona: Que tiene mala suerte o que la trae a los demás.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA D. Cuidado, prontitud, agilidad, competencia en la acción.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA E. Puesta en práctica de una acción o actividad para poder perfeccionar su ejecución.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA F. Humorista que actuaba junto a Cansado.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA G. Prueba ciclista más importante de Italia.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA H. Virtud que consiste en el conocimiento de las propias limitaciones y debilidades y en obrar de acuerdo con este conocimiento.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA I. Disco membranoso y coloreado del ojo de los vertebrados y cefalópodos, en cuyo centro está la pupila.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA J. Aficionado a la juerga.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA K. Mamífero marsupial arborícola parecido a un oso pequeño.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA M. Lugar riscoso o cubierto de maleza que lo hace impracticable.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA N. Principal río de Egipto.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CONTIENE LA Ñ. Tira de tela o celulosa absorbente que se pone a los niños pequeños o a las personas que sufren incontinencia de orina.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA P. Pequeña cantidad de comida que se toma entre horas, generalmente por capricho u ocasión más que por hambre o necesidad.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA R. Variedad de corindón (mineral óxido de aluminio) de color rojo, brillo intenso y gran dureza.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      'CON LA S. Poetisa griega de la antigüedad, a quien Platón apodó como "la décima Musa".',
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA T. Membrana tensa de tejido delgado que está situada en el oído medio y que, al recibir los sonidos, vibra y los comunica al oído interno.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA U. Maquinar y disponer cautelosamente algo contra alguien, o para la consecución de algún designio.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CONTIENE LA Y. Fruto carnoso o pulposo con varias semillas en su interior que están envueltas directamente por la pulpa; suele tener forma redondeada o elipsoidal.",
  ...
  },
  {
    ...
    status: 0,
    questionSet: [
      "CON LA Z. Práctica aeróbica que combina el baile con ejercicios físicos, creada por el coreógrafo y bailarín Beto Pérez.",
...
var game = {
  ...
  newGame: function () {
    debugger;
    sendGame.addEventListener("click", function () {
    ...
    sendAnswer.addEventListener("click", function (event) {
      ...
      if (upperCased === "PASAPALABRA") {
        outputMessage.innerHTML =
          'Has escogido "Pasapalabra". Esta palabra queda pendiente de contestar más adelante.';
      } else if (
        upperCased === questions[increment].answerSet[choose].toUpperCase()
      ) {
        ...
        outputMessage.innerHTML = `Lo siento, has fallado. La respuesta correcta era ${questions[
          increment
        ].answerSet[choose].toUpperCase()}`;
        eachLetter[increment].classList.remove("letter");
